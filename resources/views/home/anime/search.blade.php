    ...
    <div class="main__container">
        <div class="category__content mt-15">
            ...
            <div class="content__product">
                ...
                <a href="{{ route('animeShow', $product->id) }}" class="content__product-name">{{ $product->title }}</a>
                ...
                <div class="content__product-navs">
                    <button class="btn-primary">Возрасть: +{{ $product->old }}</button>
                </div>
            </div>
            @endforeach
        </div>
